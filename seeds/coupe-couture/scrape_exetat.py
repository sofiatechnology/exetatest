#!/usr/bin/env python3
"""Scrape Schoolap Coupe et Couture (option 16) into yearly exetat seeds.

Source listing:
https://www.schoolap.com/exetats/filter?q=&branch=*&option=16
...
CACHE_DIR = Path("/tmp/schoolap-coupe-couture-cache")
LISTING = "https://www.schoolap.com/exetats/filter?q=&branch=*&option=16&page={page}"
SECTION_ID = "08"
OPTION_BADGE = "Coupe et Couture"
SOURCE = "https://www.schoolap.com/exetats/filter?q=&branch=*&option=16"
...
STRONG_RULES: list[tuple[str, list[str]]] = [
    ...
    (
        ...
        [
            ...
            r"\bfayol\b",
            r"organigramme",
            r"organisation du travail",
            r"organisation scientifique",
            r"poste de travail",
            r"\bcapitaux\b",
            r"capital necessaire",
            r"entreprise",
            r"etude du marche",
            r"prix de revient",
...
PREFERRED = {
    ...
    "sc": {BIOLOGIE, MATH},
    "co": {COUPE, TEXTILE, LEGISLATION, ORGANISATION, DESSIN},
    "la": {ANGLAIS, FRANCAIS},
}
...
def match_rules(folded: str) -> str | None:
...
def looks_like_math(folded: str, paper_type: str) -> bool:
    ...
    return "![](" in folded and len(stripped) < 40 and paper_type == "sc"
...
def forced_course(title: str, item_type: str) -> str | None:
    ...
    if item_type == "la" and "dissertation" in folded:
        return FRANCAIS
    if item_type == "co" and folded.startswith("dessin") and "coupe" not in folded:
        return DESSIN
    return None
