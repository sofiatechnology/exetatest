...
const QUESTIONS_BY_TYPE: Record<
  ItemTypeEnum,
  Array<{
    question: string;
    options: string[];
...
> = {
  [ItemTypeEnum.CULTURE_GENERALE]: [
    ...
    {
      question: "En quelle année la RDC a-t-elle accédé à l'indépendance ?",
      options: ['1958', '1960', '1962', '1965'],
      answer: 1,
    },
    {
      question: "Quel est le fleuve le plus long d'Afrique centrale ?",
      options: ['Le Niger', 'Le Zambèze', 'Le Congo', 'Le Nil'],
      answer: 2,
    },
    {
      question: 'Quelle organisation regroupe les États africains ?',
      options: ['ONU', 'OTAN', 'Union Africaine', 'ASEAN'],
      answer: 2,
    },
    {
      ...
      options: [
        'Un régime militaire',
        'Un système où les citoyens participent directement aux décisions',
    ...
    {
      question: "Combien de pays composent l'Union Africaine ?",
      options: ['45', '50', '54', '60'],
      answer: 2,
    },
    {
    ...
    {
      question: "Qu'est-ce que la souveraineté nationale ?",
      options: [
        'Le pouvoir absolu du roi',
        "Le droit d'un peuple à se gouverner lui-même",
        "La puissance militaire d'un pays",
        "La richesse économique d'une nation",
      ],
      answer: 1,
    },
    {
      question: "Quel est le principe fondamental des droits de l'homme ?",
      options: [
        "Ils sont accordés par l'État",
        'Ils sont universels et inaliénables',
        'Ils varient selon les cultures',
        "Ils s'appliquent uniquement aux citoyens",
      ],
      answer: 1,
    },
  ],
  [ItemTypeEnum.SCIENCES]: [
    ...
    },
    {
      ...
      options: ['Le foie', 'Les reins', 'Le pancréas', 'La rate'],
      answer: 2,
    },
    {
    ...
    },
    {
      ...
      options: [
        'La mort cellulaire',
        'La division cellulaire produisant deux cellules identiques',
        'La fusion de deux cellules',
    ...
    },
    {
      ...
      options: ['Fe', 'Fr', 'Fi', 'Fer'],
      answer: 0,
    },
    {
      question: 'Quelle est la fonction de la chlorophylle ?',
      options: [
    ...
    {
      question: 'Quel est le tableau périodique des éléments ?',
      options: [
        'Un tableau historique des scientifiques',
        'Une classification des éléments chimiques',
        'Un graphique des températures',
        'Un tableau des réactions chimiques',
      ],
      answer: 1,
    },
  ],
  [ItemTypeEnum.COURS_OPTIONS]: [
    {
      ...
      options: [
        'Un circuit avec plusieurs branches parallèles',
        "Un circuit où les composants sont branchés l'un après l'autre",
        'Un circuit sans résistance',
    ...
    },
    {
      ...
      options: ['P = UI', 'U = RI', 'I = P/U', 'R = UI'],
      answer: 1,
    },
    {
      question: "Qu'est-ce que la comptabilité en partie double ?",
      options: [
        'Tenir deux livres comptables',
        'Chaque opération affecte au moins deux comptes',
        'Doubler les bénéfices',
        'Compter deux fois les dépenses',
      ],
      answer: 1,
    },
    {
      ...
      options: [
        ...
        'Protéger un circuit contre les surcharges',
    ...
    },
    {
      ...
      options: [
        ...
        "Un tableau représentant l'actif et le passif d'une entreprise",
        'Un résumé des ventes',
    ...
    {
      question:
        'Quelle matière première est la plus utilisée en construction ?',
      options: ['Le bois', 'Le métal', 'Le béton', 'Le verre'],
      answer: 2,
    },
    {
    ...
    },
    {
      ...
      options: [
        'Tourner le tracteur',
        'Alterner les cultures sur une même parcelle',
        'Irriguer les champs',
        'Récolter en automne',
      ],
      answer: 1,
    ...
    {
      question: 'Quel est le principe du moteur à explosion ?',
      options: [
        "L'énergie solaire",
        "La combustion d'un mélange air-carburant",
    ...
    },
    {
      ...
      options: [
        ...
        "L'opposition d'un matériau au passage du courant",
        "La puissance d'un circuit",
  ...
  [ItemTypeEnum.LANGUES]: [
    {
      question: 'Quel est le sujet de la phrase : "Le chat mange la souris" ?',
      options: ['mange', 'la souris', 'Le chat', 'aucun'],
      answer: 2,
    },
    {
      question: "Qu'est-ce qu'un adverbe ?",
      options: [
        'Un mot qui désigne une personne',
        'Un mot qui modifie un verbe, un adjectif ou un autre adverbe',
        'Un mot qui exprime une action',
        'Un mot qui remplace un nom',
      ],
      answer: 1,
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        'Une comparaison sans outil comparatif',
    ...
    },
    {
      ...
      options: ['Vif', 'Lent', 'Fort', 'Grand'],
      answer: 1,
    },
    {
      question: "Comment s'appelle la virgule en français ?",
      options: ['Point-virgule', 'Virgule', 'Tiret', 'Apostrophe'],
      answer: 1,
    },
    {
      ...
      options: [
        ...
        'Un mot de même sens',
        'Un mot de même son',
        'Un mot de même étymologie',
      ],
      answer: 1,
    },
    {
      question:
        'Quelle figure de style est utilisée dans "Il pleut des cordes" ?',
      options: [
        'Une métonymie',
        'Une hyperbole',
        'Une métaphore',
    ...
    {
      question: "Qu'est-ce que le COD ?",
      options: [
        "Complément d'objet direct",
        "Complément d'origine directe",
        'Complément obligatoire du nom',
        "Complément d'objet déterminé",
      ],
      answer: 0,
    },
    {
      question: 'Quel est le pluriel du mot "cheval" ?',
      options: ['Chevals', 'Chevaux', 'Chevales', 'Chevauls'],
      answer: 1,
    },
  ],
};
  ...
  for (let i = 0; i < allItems.length; i++) {
    ...
    if ((i + 1) % 100 === 0 || i + 1 === allItems.length) {
      process.stdout.write(
        `\r📝 Processed ${i + 1} / ${allItems.length} items...`,
      );
    }
  }
